...
<th class='delivery box'>Order Date</th>
<th class='order box'>Order Status</th>    
<th class='action  box'>     Cancel Order     </th>  
</table></div>";


$sql_result=mysqli_query($conn,"select * from order_table left join product_details on order_table.pid=product_details.pid");
